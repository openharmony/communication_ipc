...
#include "dbindergetpiduid_fuzzer.h"
...
namespace OHOS {
void DBinderGetPidUidFuzzTest(const uint8_t *data, size_t size)
{
    ...
    ipcObjectStub->DBinderGetPidUid(code, parcel, parcel, option);
...
extern "C" int LLVMFuzzerTestOneInput(const uint8_t *data, size_t size)
{
    ...
    OHOS::DBinderGetPidUidFuzzTest(data, size);
    return 0;
}
