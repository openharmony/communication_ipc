...
enum DBinderErrorCode {
    DBINDER_OK                          = 100,
    DBINDER_STUB_INVALID                = 101,
    DBINDER_SEND_MESSAGE_FAILED         = 102,
    DBINDER_MAKE_THREADLOCK_FAILED      = 103,
    DBINDER_WAIT_REPLY_TIMEOUT          = 104,
    DBINDER_QUERY_REPLY_SESSION_FAILED  = 105,
    DBINDER_SA_NOT_FOUND                = 106,
    DBINDER_SA_INVOKE_FAILED            = 107,
    DBINDER_DEVICEID_INVALID            = 108,
    DBINDER_SESSION_NAME_NOT_FOUND      = 109,
    DBINDER_WRITE_PARCEL_FAILED         = 110,
    DBINDER_INVOKE_STUB_THREAD_FAILED   = 111,
    DBINDER_SESSION_NAME_INVALID        = 112,
    DBINDER_SA_NOT_AVAILABLE            = 113,
    DBINDER_SAID_INVALID                = 114,
    DBINDER_SA_NOT_DISTRUBUTED          = 115,
    DBINDER_ALLOC_OBJECT_FAILED         = 116,
};
