...
HWTEST_F(IPCObjectProxyTest, RemoveDeathRecipientTest003, TestSize.Level1)
{
    ...
    object->recipients_.insert(std::make_pair(deathInfo->recipient_.GetRefPtr(), deathInfo));
    object->recipients_.insert(std::make_pair(deathInfo2->recipient_.GetRefPtr(), deathInfo2));
    object->isRemoteDead_ = false;
    object->proto_ = IRemoteObject::IF_PROT_ERROR;
