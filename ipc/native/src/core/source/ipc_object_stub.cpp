...
{
    ZLOGW(LABEL, "destroyed, desc:%{public}s, addr:%{public}s", Str16ToStr8(IPCProcessSkeleton::IpcConvertToString(descriptor_)).c_str(),
        Str16ToStr8(UIntToString(this)).c_str());
}
