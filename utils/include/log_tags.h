...
const unsigned int LOG_ID_IPC_COMMON = LOG_ID_COMMUNICATION | 0x42C0;
const unsigned int LOG_ID_IPC_PROXY = LOG_ID_COMMUNICATION | 0x42C1;
const unsigned int LOG_ID_IPC_STUB = LOG_ID_COMMUNICATION | 0x42C2;
const unsigned int LOG_ID_IPC_THREAD_SKELETON = LOG_ID_COMMUNICATION | 0x42C3;
const unsigned int LOG_ID_IPC_PROCESS_SKELETON = LOG_ID_COMMUNICATION | 0x42C4;
const unsigned int LOG_ID_IPC_BINDER_INVOKER = LOG_ID_COMMUNICATION | 0x42C5;
const unsigned int LOG_ID_IPC_BINDER_CONNECT = LOG_ID_COMMUNICATION | 0x42C6;
const unsigned int LOG_ID_IPC_TEST = LOG_ID_COMMUNICATION | 0x42C7;
const unsigned int LOG_ID_IPC_NAPI = LOG_ID_COMMUNICATION | 0x42C8;
const unsigned int LOG_ID_IPC_OTHER = LOG_ID_COMMUNICATION | 0x42C9;
